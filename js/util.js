...
const I = {
  ...
  // one person, drawn symmetrically about x=12 so it sits centred in a circle --
  // the two-people glyph above is deliberately left-heavy and never will
  user:'M12 11a3.6 3.6 0 1 0 0-7.2 3.6 3.6 0 0 0 0 7.2M4.9 19.8v-1.1a5.6 5.6 0 0 1 5.6-5.6h3a5.6 5.6 0 0 1 5.6 5.6v1.1',
  ...
  book:'M4 19.5A2.5 2.5 0 0 1 6.5 17H20M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2ZM8.5 7h7M8.5 11h7',
